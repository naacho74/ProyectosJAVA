...
public class Mercancia {
    ...
    public String getUltimpoProceso() {
        return ultimpoProceso;
    }

    public void setUltimpoProceso(String ultimpoProceso) {
        this.ultimpoProceso = ultimpoProceso;
    }
}
